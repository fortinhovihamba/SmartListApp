  ...
  <div class="jumbotron" id="div-id-name">
    <div>
      <div style="margin-left:150px;">
        <a class="btn btn btn-primary" style="width:20%" href="dashboard.php?p=edituser&id=<?php echo $id?>"><i class="fa fa-edit"></i> &nbsp;Edit</a>
        <a onclick="return confirm('Etes-vous sûr de vouloir supprimer <?php echo $name?> ?')"style="width:20%" class="btn btn btn-danger"
          href="../../app/deleteuser.php?id=<?php echo $id;?>"><i class="fa fa-trash"></i> &nbsp;Delete</a> &nbsp;
