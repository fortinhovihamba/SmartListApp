...
<div style="margin-left:15%;width:5000px"> 
  ...
  <hr class="my-4">
  <h5 class="p-3 mb-2 bg-dark text-white text-center">DETAIL UTILISATEUR </h5>
  <div class="jumbotron" id="div-id-name">
    <div>
      <div style="margin-left:150px;">
        <a class="btn btn btn-primary" style="width:20%" href="dashboard.php?p=editcptEns&id=<?php echo $id?>"><i class="fa fa-edit"></i> &nbsp;Edit</a>
        <a onclick="return confirm('Etes-vous sûr de vouloir supprimer <?php echo $name?> ?')"style="width:20%" class="btn btn btn-danger"
          href="../../app/deletcptEns.php?id=<?php echo $id;?>"><i class="fa fa-trash"></i> &nbsp;Delete</a> &nbsp;
