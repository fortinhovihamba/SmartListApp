...
<div style="margin-left:15%;width:6000px">
  ...
  <hr class="my-4">
  <h5 class="p-3 mb-2 bg-dark text-white text-center">COMPTES ÉTUDIANT </h5>
     ...
     <table class="table table-striped  table-dark">
      ...
      <tbody>
        ...
        <tr>
            ...
            <td>
              <a class="btn btn-sm btn-outline-warning" href="dashboard.php?p=detailcomptStd&id=<?php echo $data['idcmptstd']?>"><i class="fa fa-eye"></i></a>
            </td>
